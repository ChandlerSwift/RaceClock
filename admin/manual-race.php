...
include_once "../includes/db.inc.php";
	if (isset($_POST["userid"])) {
		...
		$db->exec("INSERT INTO times (userid,vehicle,time_ms,time_str,timestamp,rs) VALUES ('" . $_POST['userid']. "','" . $_POST['vehicle'] . "','" . $time_ms."','".$timestr."','".$_POST['timestamp']."','".$rs."')");
...
<br>
 ...
 Vehicle: <input type="radio" name="vehicle" value="1" checked> Dirt Bike 
  ...
  <input type="checkbox" name="rs" value="1"> Rolling Start?<br>
